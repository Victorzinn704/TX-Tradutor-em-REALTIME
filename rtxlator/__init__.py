...
from .device import detect_device, find_redragon_devices, list_all_devices
...
__all__ = [
    ...
    "preload_nvidia_dlls",
    # constants
    "DEFAULT_PROFILE", "MODELS_DIR", "WHISPER_SR", "console", "normalize_lang_choice", "ui",
    # context
    "CONTEXT_PATH", "ContextStore", "PersonalLanguageContext",
    # device
    "detect_device", "find_redragon_devices", "list_all_devices",
    # audio
